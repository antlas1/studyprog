...
1.2.int    Целочисленный тип данных включает множество целых чисел и целочисленные арифметические операции.(1.2.type,1.2.carif,1.2.intmn)
1.2.skob Для управления приоритетом вычисления операций в выражении необходимо использовать скобки. (1.2.sexpr)
1.2.full Целое число (1.2.int,1.2.skob,1.2.cres)
...
1.3.float    Вещественный тип данных включает множество вещественных чисел и вещественные арифметические операции.(1.2.type,1.3.farif,1.3.floatmn)
1.3.floatret Арифметические операции для двух вещественных чисел возвращают вещественное число. (1.3.farif)     
1.3.full Вещественное число (1.3.floatret,1.3.float,1.3.floatp)
...
root Знания по курсу (1.1.full, 1.2.full, 1.3.full, 1.4.full, 1.5.full, 1.6.full)     
...
xx.equ Все типы данных поддерживают операцию сравнения.(1.2.type)     
xx.float Вещественный тип данных - включает множество рациональных чисел и арифметические операции над вещественными числами.(1.2.var,1.2.type,1.2.equ)    
xx
xx.uvar Объявление переменной в алгоритме необходимо перед первым использованием.(1.2.var,1.1.alg)     
xx.bvar Переменная объявляется на блок-схеме через оператор объявления.(1.2.var,1.1.block)     
xx.odesc Оператор объявления выглядит как прямоугольник с рамками.(1.2.bvar)    
xx.assign Операции присваивания предназначена для копирования значения выражения с правой стороны в переменную слева.(1.2.var,1.2.expr)     
xx.bass Оператор присваивания на блок-схеме обозначается прямоугольником.(1.2.assign)    
xx.full Переменные и константы(1.2.bass,1.2.odesc,1.2.uvar,1.2.bool,1.2.float,1.2.int,1.2.nvar,1.2.desc,1.2.idreg,1.2.iddup,1.2.ids,1.2.idf)    
